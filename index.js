...
const { color } = require('./Lunox-Prime/lib/color');
const { smsg, sleep, getBuffer } = require('./Lunox-Prime/lib/myfunction');
const { imageToWebp, videoToWebp, writeExifImg, writeExifVid, addExif } = require('./Lunox-Prime/lib/exif')
...
if (typeof handler === "function") {
    ...
    client.ev.on('connection.update', (update) => {
        const { konek } = require('./Lunox-Prime/lib/connection/connect')
  ...
  if (global.welcome = true) {
    ...
    for(let n of participants) {
      ...
      try {
        ...
        profile = 'https://files.catbox.moe/lck4pw.jpg';
      }
...
await client.relayMessage(id, {
  "productMessage": {
    ...
    "businessOwnerJid": "6285183387097@s.whatsapp.net",
    "contextInfo": {
      mentionedJid: [n]
    }
  }
